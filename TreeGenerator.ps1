...
# Version: 1.0.0
# Author: LaneZero
# GitHub: https://github.com/LaneZero/DirTreePhoria
...
$script:config = @{
    ...
    Version = "1.0.0"
    Author = "LaneZero"
    GitHubUrl = "https://github.com/LaneZero/DirTreePhoria"
}
...
function Get-FolderPath {
    ...
    ## If a . is entered, the current path is returned
